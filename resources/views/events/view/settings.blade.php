        ...
        <div class="col-md-7">
            <fieldset>
                ...
                <div class="form-group @InputClass('em_id')">
                    ...
                    @else
                        {!! Form::memberList('em_id', null, [
                            'class' => 'form-control',
                            'select2' => true,
                            'include_blank' => true,
                            'blank_text' => '-- No Event Manager --',
                        ]) !!}
                        @InputError('em_id')
                    @endif
                </div>
                ...
                >
                    ...
                    @else
                        <p class="form-control-static">{{ \App\Models\Events\Event::$VenueTypes[$event->venue_type ?: 1] }}
                        </p>
                    @endcan
                </div>
                {{-- Venue --}}
                ...
                <div class="form-group @InputClass('description')">
                    ...
                    <p class="help-block alt">This will be visible to the public. This also supports
                        {!! link_to('https://simplemde.com/markdown-guide', 'markdown', ['target' => '_blank']) !!}.</p>
                </div>
        ...
        <div class="col-md-5">
            <fieldset>
                ...
                <div class="form-group @InputClass('crew_list_status')">
                    ...
                    {!! Form::select('crew_list_status', \App\Models\Events\Event::$CrewListStatus, null, [
                        'class' => 'form-control',
                    ]) !!}
            ...
            @can('delete', $event)
                <fieldset>
                    ...
                    <div class="form-group">
                        <p>
                            Deleting the event will remove any crew, time and email information. This process cannot be
                            reversed.
                        </p>
                        <button

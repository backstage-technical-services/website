        ...
        <div class="status-selector">
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                        <button
                            data-submit-ajax="{{ route('award.season.status', ['id' => $season->id]) }}"
                            data-status=""
                            data-redirect="true"
...
@section('content')
    ...
    @else
        <div class="closed-info">
            ...
            <p>
                This means that only administrators can see this page, allowing you to manage the award without it affecting
                members' nominations or votes.
            </p>
            <p>
                Once the award is ready for nominations, voting or results to be opened, click the corresponding button
                below.
            </p>
        </div>
    @endif

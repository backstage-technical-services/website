...
@section('content')
    ...
    <fieldset>
        ...
        <p>You do not need to provide your details, but we discourage anonymous reporting as it prevents the committee from collecting further information if needed.</p>

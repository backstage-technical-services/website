...
@section('tab')
    <p>We always strive to provide a professional service to all of our clients but we know that there is room for improvement. If you have recently been involved with an event at which we assisted and have feedback (either positive or negative) we would really appreciate it if you could fill in the form below.</p>

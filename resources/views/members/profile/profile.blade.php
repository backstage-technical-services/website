    ...
    <div class="row">
        <div class="col-sm-6 box">
            ...
            <table>
                ...
                <tr>
                    <td>Committee:</td>
                    <td><span class="fa-lg fa fa-{{ $user->isCommittee() ? 'check success' : 'remove danger' }}"></span>
                    </td>
                </tr>
                <tr>
                    <td>Associate:</td>
                    <td><span class="fa-lg fa fa-{{ $user->isAssociate() ? 'check success' : 'remove danger' }}"></span>
                    </td>
                </tr>
